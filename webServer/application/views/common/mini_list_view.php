<?php
$thisListInfo = $this->dataInfo->field_list[$v]->linked_lists;
?>
<div class="row">
    <?php
    if ($this->canEdit):
    ...
    <div class="col-lg-12 list-title-op">
        <a href="javascript:void(0)" class="btn btn-primary btn-sm" onclick="lightbox({size:'m',url:'<?=site_url($thisListInfo->create_link)?>'})"><span class="glyphicon glyphicon-file"></span> 新建</a>
