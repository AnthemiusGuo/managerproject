...
include_once(APPPATH."models/records/peijianweixiu_model.php");

class Field_array_peijianweixiu extends Fields {
    ...
    public function init($value){
        ...
        foreach ($value as $key => $this_item) {
            $this->real_data[(string)$this_item['_id']] = new Peijianweixiu_model();
