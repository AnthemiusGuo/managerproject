...
include_once(APPPATH."models/records/fuwuxiangmu_model.php");

class Field_array_xiangmu extends Field_array_hash {
    ...
    public function init($value){
        ...
        foreach ($value as $key => $this_item) {
            $this->real_data[(string)$this_item['_id']] = new Fuwuxiangmu_model();
    ...
    public function gen_show_html(){
        $this->CI->xiangmuDataInfo = $this;
        $editor = $this->CI->load->view('editor/xiangmu_show', '', true);
        return $editor;
    }
