...
include_once(APPPATH."models/records/guzhangjiance_model.php");

class Field_array_guzhang extends Fields {
    ...
    public function init($value){
        ...
        foreach ($value as $key => $this_item) {
            $this->real_data[(string)$this_item['_id']] = new Guzhangjiance_model();
